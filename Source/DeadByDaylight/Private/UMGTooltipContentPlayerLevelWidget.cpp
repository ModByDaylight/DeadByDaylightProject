...
UUMGTooltipContentPlayerLevelWidget::UUMGTooltipContentPlayerLevelWidget() {
    this->PlayerLevelText = INVTEXT("Your <B>Player Level</B> represents your OVERALL PROGRESSION. All characters that you play, whether Killer or Survivor, contribute to your Player Level.");
