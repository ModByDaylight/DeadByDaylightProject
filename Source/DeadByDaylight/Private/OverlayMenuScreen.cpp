...
void UOverlayMenuScreen::SetGameType(EGameType gameType) {
}
...
void UOverlayMenuScreen::OnPlayerInfoClick(const FString& playerId) {
}
...
UOverlayMenuScreen::UOverlayMenuScreen() {
}
